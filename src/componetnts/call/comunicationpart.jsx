function ComunicationPart() {
    return (
        <div className=" w-full h-auto flex justify-center mt-10">
            <div className=" w-full h-full flex flex-row-reverse smmax:flex-col max-w-[1300px]">
                <div className=" w-1/3 smmax:w-full px-3 min-w-[300px]">
                    <form class="bg-white p-6 rounded-lg shadow-md my-5">
                        <div class="mb-4">
                ...
                <div className=" w-2/3 smmax:w-full px-3">
                    <ul className=" w-full justify-between flex flex-col gap-10">
                        <li className=" w-full  mdmax:w-full flex flex-col">
                            <h2 className=" text-red-500 text-xl w-full py-2 font-bold border-b border-gray-300 mb-3">تماس با کارشناسان ما</h2>
                        ...
                        <li className=" w-full  mdmax:w-full flex flex-col">
                            <h2 className=" text-red-500 text-xl w-full py-2 font-bold border-b border-gray-300 mb-3">ارسال ایمیل</h2>
                            <div className=" flex items-center gap-3">
                        ...
                        <li className=" w-full  mdmax:w-full flex flex-col">
                            <h2 className=" text-red-500 text-xl w-full py-2 font-bold border-b border-gray-300">شبکه های اجتماعی</h2>
